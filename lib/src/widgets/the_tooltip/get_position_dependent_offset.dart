...
Offset getPositionDependentOffset({
  ...
  switch (axisDirection) {
    ...
    case AxisDirection.up:
      final bool tooltipAbove = axisDirection == AxisDirection.up;
      final double childAndOffsetHeight = offsetAndTail + childSize.height;
      final double targetHeightRadius = targetSize.height / 2;
      final double bottomTargetEdge = target.dy + targetHeightRadius;
      final double topTargetEdge = target.dy - targetHeightRadius;
      ...
      if (size.width - margin.horizontal < childSize.width) {
        ...
        final double normalizedTargetX = target.dx.clamp(
          margin.left,
    ...
    case AxisDirection.right:
      final bool tooltipLeft = axisDirection == AxisDirection.left;
      final double childAndOffsetWidth = offsetAndTail + childSize.width;
      final double targetWidthRadius = targetSize.width / 2;
      final double rightTargetEdge = target.dx + targetWidthRadius;
      final double leftTargetEdge = target.dx - targetWidthRadius;
